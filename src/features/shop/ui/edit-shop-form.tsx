...
export default function EditShopForm({
    ...
    const form = useForm<UpdateShopInput>({
        ...
        defaultValues: {
            ...
            open_time: initialData.open_time ? new Date(initialData.open_time).toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit' }) : null,
            close_time: initialData.close_time ? new Date(initialData.close_time).toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit' }) : null,
        },
    });
        ...
        <Form {...form}>
            ...
            >
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                ...
                                <SelectContent>
                                    {Object.values(ShopOrderMode).map((value) =>
                                        <SelectItem value={value} key={value}>{shopOrderModeMapping[value]}</SelectItem>
                                    )}
                                </SelectContent>
                            </Select>
                            <FormMessage />
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                ...
                                <SelectContent>
                                    {Object.values(RefundDisbursementMode).map((value) =>
                                        <SelectItem value={value} key={value}>{refundDisbursementModeMapping[value]}</SelectItem>
                                    )}
                                </SelectContent>
                            </Select>
                            <FormMessage />
                ...
                <div className="flex justify-center gap-3">
                    <NavButton href={"/admin/kedai"}>Kembali</NavButton>
