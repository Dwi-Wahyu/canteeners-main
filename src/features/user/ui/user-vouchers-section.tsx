          ...
          <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="p-0 overflow-hidden rounded-[28px] border-none shadow-[0_32px_64px_rgba(0,0,0,0.2)] max-w-md w-full flex flex-col max-h-[88dvh] outline-none">
              <div className="uvs-liquid-bg flex flex-col flex-1 min-h-0">
                {/* Header */}
                <DialogHeader className="relative z-50 shrink-0">
                  <div
                  ...
                  >
                    ...
                    />
                    <div className="w-10" />
                    <DialogTitle className="font-extrabold text-[17px] tracking-tight text-white drop-shadow-xs">
                      Voucher Aktif
                    </DialogTitle>
                    <button
                      ...
                      >
                        ...
                        <div className="flex-1 p-4 flex flex-col justify-center gap-1.5 min-w-0">
                          <div className="flex items-center gap-1.5 mb-0.5">
                            <Tag className="size-3 text-red-400 shrink-0" />
                            <span className="text-[9px] font-bold text-red-400 uppercase tracking-widest">
                        ...
                        {/* Value */}
                        <div className="uvs-value-pane w-[88px] shrink-0 flex flex-col items-center justify-center p-3 rounded-r-2xl gap-0.5">
                          <span
                ...
                {/* Footer */}
                <div
                  className="px-5 py-4 shrink-0 relative z-20"
                  style={{
