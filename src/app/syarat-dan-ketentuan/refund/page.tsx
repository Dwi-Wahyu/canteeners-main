...
export default async function KebijakanRefundPage({
  ...
  return (
    <div className="min-h-screen bg-background pb-10">
      <TopbarWithBackButton title="Kebijakan Refund" backUrl={back_url || "/"} />
      ...
      <div className="max-w-4xl mx-auto px-5 pt-24 space-y-8 text-gray-800 leading-relaxed text-justify">
        <header>
          ...
          <div className="mt-6 text-muted-foreground space-y-4">
            <p>
              ...
              Kantiners. Dokumen ini mengatur hak pengguna serta prosedur terkait
              pembatalan pesanan dan pengembalian dana di dalam platform
              Kantiners.
            </p>
          </div>
        </header>
        ...
        <section className="mb-8">
          ...
          <ol className="list-decimal pl-5 space-y-3">
            <li>
              ...
              melakukan pembayaran. (<em>Catatan: Jika Pengguna memesan beberapa
              menu dan hanya 1 menu yang habis, maka yang di-refund hanya seharga
              menu yang habis tersebut / Partial Refund</em>).
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Untuk memproses <em>refund</em>, Pengguna wajib memenuhi
            persyaratan berikut:
          </p>
        ...
        <section className="mb-8">
          ...
          <ol className="list-decimal pl-5 space-y-3">
            ...
            <li>
              ...
              selambat-lambatnya <strong>2x24 (satu kali dua puluh empat) jam</strong>{" "}
        ...
        <section className="mb-8">
          ...
          <ol className="list-decimal pl-5 space-y-3">
            ...
            <li>
              ...
              memahami bahwa Kantiners{" "}
              <strong>tidak berkewajiban</strong> untuk menanggung atau mengganti
              dana tersebut dari kas perusahaan Kantiners apabila pihak Kedai
              gagal melakukan <em>refund</em>.
            </li>
            <li>
        ...
        <section className="mb-8 bg-gray-50 p-5 rounded-lg border border-gray-200">
          ...
          <p className="text-sm mb-3">
            Jika Anda memiliki pertanyaan lebih lanjut terkait status pengembalian
            dana Anda, silakan hubungi Layanan Pelanggan (CS) Kantiners melalui:
          </p>
