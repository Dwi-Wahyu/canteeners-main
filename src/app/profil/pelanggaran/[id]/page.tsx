...
export default async function ViolationDetailPage({
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-10">
      <TopbarWithBackButton title="Detail Pelanggaran" backUrl="/profil/pelanggaran" />
      ...
      <div className="max-w-md mx-auto px-5 pt-24 space-y-6">
        ...
        <Card className="overflow-hidden border-none shadow-sm">
          <CardContent className="p-0">
            <div className="bg-white p-5 space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-0.5">
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Waktu Kejadian</p>
                  <p className="text-sm font-semibold text-gray-900">
                    {format(new Date(violation.timestamp), "EEEE, d MMMM yyyy", { locale: idLocale })}
                  </p>
                  <p className="text-xs text-muted-foreground">Pukul {format(new Date(violation.timestamp), "HH:mm")} WIB</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    {customerViolationDescriptionMapping[violation.type] || "Pelanggaran aturan penggunaan layanan."}
                  </p>
                </div>
              </div>
            </div>
            ...
            {violation.order_id && (
              <div className="bg-gray-50 border-t p-5 flex items-center justify-between group">
                <div className="flex items-center gap-4">
                  <div className="size-10 bg-white rounded-lg flex items-center justify-center shadow-xs text-blue-600 border">
                    <History className="size-5" />
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Terkait Pesanan</p>
                    <p className="text-xs font-bold text-gray-700">#{violation.order_id.slice(0, 8)}...</p>
                  </div>
                </div>
                <Button asChild size="sm" variant="outline" className="rounded-full gap-1.5 font-bold text-xs h-9">
        ...
        <div className="space-y-4 pt-2">
          <h2 className="text-xs font-bold text-gray-400 uppercase tracking-widest px-1 flex items-center gap-2">
            <Gavel className="size-3" /> Tindakan Lanjutan
          </h2>
          ...
          <div className="space-y-3">
            <div className="bg-amber-50 border border-amber-100 rounded-2xl p-4 flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-amber-900 text-sm">Peringatan Keras</h3>
                <p className="text-xs text-amber-700 leading-relaxed mt-1">
                  Akun Anda tercatat melakukan aktivitas yang merugikan mitra kedai. 
                  Jika pelanggaran yang sama terulang kembali dalam waktu dekat, 
                  akun akan dibekukan sementara secara otomatis.
                </p>
              </div>
            </div>

            <Button asChild variant="outline" className="w-full h-14 rounded-2xl border-gray-200 text-gray-700 font-bold gap-2">
